...
J = 100;            % # of samples
N = 256; %64;
L = 512; %128;           % The dictionary is of size N x L
%kk = 1:10:N/2;      % sparsity
kk = 64:8:144;
...
% plot(t,Rate_FGL1,'r-o','Color',[0.5, 0, 0.5],'linewidth',lw,'MarkerIndices',1:lenk/num:lenk,'markersize', ms,'DisplayName','Alg_{GL1}^F');hold on;
...
legend('show','Location', 'southwest','NumColumns', nc,'FontSize',fs-8)
set(gca,'FontSize',fs);
set(gcf, 'Color', 'w');
axis tight
% export_fig 'figs/fig_Data_N256_rho.pdf'; 
...
% plot(t,time_GL1,'-*','Color',[0.5, 0, 0.5],'Color',[0.5, 0.8, 1],'linewidth',lw,'MarkerIndices',1:lenk/num:lenk,'markersize', ms,'DisplayName','Alg_{GL1}');hold on;
% plot(t,time_FGL1,'r-o','linewidth',lw,'MarkerIndices',1:lenk/num:lenk,'markersize', ms,'DisplayName','Alg_{GL1}^F');hold on;
...
legend('show','Location', 'northwest','NumColumns', nc,'FontSize',fs-8)
set(gca,'FontSize',fs);
set(gcf, 'Color', 'w');
axis tight
% export_fig 'figs/fig_Data_N256_Tc.pdf'; 
